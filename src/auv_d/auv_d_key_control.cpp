	...
	while(do_not_quit){
		...
		switch(input){
			case 'q': do_not_quit = false;
					  break;
			case 's': cur_set_point[0] = cur_set_point[0] + 0.1;
					  break;
			case 'a': cur_set_point[0] = cur_set_point[0] - 0.1;
					  break;
			case 'l': cur_set_point[1] = cur_set_point[1] + 0.1;
					  break;
			case 'k': cur_set_point[1] = cur_set_point[1] - 0.1;
					  break;
		}		
	}
}
